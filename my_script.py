...
def get_report_variables():
    ...
    "compression_rcc": quality_rcc.get('compressionClass', "not available"),
    ...
    "compression_lcc": quality_lcc.get('compressionClass', "not available"),
    ...
    "post_surgery_lcc": ' '.join(quality_lcc.get('PostSurgery', "no")),
    ...
    "compression_rmlo": quality_rmlo.get('compressionClass', "not available"),
    ...
    "compression_lmlo": quality_lmlo.get('compressionClass', "not available"),
