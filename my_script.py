...
microcalc_types):
    ...
    "blur_rcc": quality_rcc.get('blur', "sharp"),
    "pnl_rcc": quality_rcc.get('PNL', "not available"),
    "pnl_diff_rcc": quality_rcc.get('pecto_nipple_length', "-"),
    ...
    "blur_lcc": quality_lcc.get('blur', "sharp"),
    "pnl_lcc": quality_lcc.get('PNL', "not available"),
    "pnl_diff_lcc": quality_lcc.get('pecto_nipple_length', "-"),
    ...
    "blur_rmlo": quality_rmlo.get('blur', "sharp"),
    "pnl_rmlo": quality_rmlo.get('PNL', "not available"),
    "pnl_diff_rmlo": quality_rmlo.get('pecto_nipple_length', "-"),
    ...
    "blur_lmlo": quality_lmlo.get('blur', "sharp"),
    "pnl_lmlo": quality_lmlo.get('PNL', "not available"),
    "pnl_diff_lmlo": quality_lmlo.get('pecto_nipple_length', "-"),
...
def get_cuts(parenchyma_cuts, proj_name):
    ...
    """
    # Check if there are cuts to process
    if not parenchyma_cuts:
        return ''
